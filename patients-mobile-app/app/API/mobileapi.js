...
export const createPatients = async (patients) => {
  ...
  export const getNearbyDoctors = async (patientId) => {
    ...
    const res = await fetch(`http://localhost:5000/api/patients/nearby-doctors/${patientId}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        // Authorization: `Bearer ${token}`, // Uncomment when auth is implemented
  ...
  export const bookSlot = async (slotId, bookingData) => {
    ...
    const res = await fetch(`http://localhost:5000/api/patients/doctors/${slotId}/book`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        // Authorization: `Bearer ${token}`, // Uncomment when auth is implemented
  ...
  export const enterPin = async (pinData) => {
    ...
    const res = await fetch("http://localhost:5000/api/patients/booked/pin", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        // Authorization: `Bearer ${token}`, // Uncomment when auth is implemented
  ...
  export const searchDoctors = async (searchParams) => {
    ...
    const res = await fetch(`http://localhost:5000/api/patients/doctors/search?${queryString}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        // Authorization: `Bearer ${token}`, // Uncomment when auth is implemented
  ...
  export const getRecordsByFamilyId = async (familyId) => {
    ...
    const res = await fetch(`http://localhost:5000/api/patients/family/records/${familyId}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        // Authorization: `Bearer ${token}`, // Uncomment when auth is implemented
  ...
  export const subscribeDoctor = async (subscriptionData) => {
    ...
    const res = await fetch("http://localhost:5000/api/patients/doctors/subscribe", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        // Authorization: `Bearer ${token}`, // Uncomment when auth is implemented
  ...
  export const unsubscribeDoctor = async (unsubscriptionData) => {
    ...
    const res = await fetch("http://localhost:5000/api/patients/doctors/unsubscribe", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        // Authorization: `Bearer ${token}`, // Uncomment when auth is implemented
  ...
  export const getSubscribedDoctors = async (familyId) => {
    ...
    const res = await fetch(`http://localhost:5000/api/patients/doctors/subscribed/${familyId}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        // Authorization: `Bearer ${token}`, // Uncomment when auth is implemented
  ...
  export const getAllBookings = async (familyId) => {
    ...
    const res = await fetch(`http://localhost:5000/api/patients/bookings/${familyId}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        // Authorization: `Bearer ${token}`, // Uncomment when auth is implemented
