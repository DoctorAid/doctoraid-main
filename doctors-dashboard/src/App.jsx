      ...
      <div className='flex justify-around gap-2 w-full h-[60%] bg-[#93b1ec] items-center px-1 py-1'>
        ...
        <div className='bg-white w-full h-full flex flex-col items-start px-6 py-4 shadow-md rounded-lg overflow-y-scroll'>
          ...
          <div className='w-full border-b-[1px] border-[#7da4f2] pb-3 mb-3'>
            <p className='text-sm text-black'><span className='font-semibold'>Last Checked</span> <span className='font-normal'>10 Dec 2023</span></p>
          ...
          {/* Consultation Item 2 */}
          <div className='w-full border-b-[1px] border-[#7da4f2] pb-3 mb-3'>
            <p className='text-sm text-black'><span className='font-semibold'>Last Checked</span> <span className='font-normal'>22 Nov 2023</span></p>
          ...
          {/* Consultation Item 3 */}
          <div className='w-full border-b-[1px] border-[#7da4f2] pb-3 mb-3'>
            <p className='text-sm text-black'><span className='font-semibold'>Last Checked</span> <span className='font-normal'>05 Oct 2023</span></p>
          ...
          {/* Consultation Item 4 */}
          <div className='w-full border-b-[1px] border-[#7da4f2] pb-3 mb-3'>
            <p className='text-sm text-black'><span className='font-semibold'>Last Checked</span> <span className='font-normal'>12 Sep 2023</span></p>
          ...
          {/* Consultation Item 5 */}
          <div className='w-full border-b-[1px] border-[#7da4f2] pb-3 mb-3'>
            <p className='text-sm text-black'><span className='font-semibold'>Last Checked</span> <span className='font-normal'>25 Aug 2023</span></p>
