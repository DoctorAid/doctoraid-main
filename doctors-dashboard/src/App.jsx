    ...
    <div className='flex flex-col gap-5 bg-[#FAFAF9] w-full px-2 py-2 items-start justify-start text-black'>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 w-full">
        <div className="space-y-4 col-span-1">
          {/* Session ID Section */}
          <div className="bg-blue-200 p-6 rounded-xl shadow-md h-40 flex items-center justify-between">
            {/* Session ID Left-Aligned */}
            <div>
              <h2 className="text-2xl font-semibold text-[#1a237e]">Session ID</h2>
              <h3 className="text-4xl font-bold text-[#295567]">#2241206</h3>
            </div>

            {/* Left and Total - Right Aligned with Matching Font Size */}
            <div className="flex space-x-12">
              <div className="text-center">
                <p className="text-2xl font-semibold text-[#295567]">Left</p>
                <p className="text-4xl font-extrabold text-[#295567]">15</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-semibold text-[#152945]">Total</p>
                <p className="text-4xl font-extrabold text-[#152945]">20</p>
              </div>
            </div>
          </div>
