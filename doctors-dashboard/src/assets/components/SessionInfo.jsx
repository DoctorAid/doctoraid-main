  ...
  return (
    <div className="flex items-center justify-between bg-[#CFE6F5] rounded-3xl p-6 w-full max-w-md">
      ...
      <div>
        ...
        <p className="text-2xl font-bold text-[#5B89A6]">#{props.SessionId}</p>
      </div>
      ...
      <div className="flex items-center gap-6">
        <div className="text-center">
          ...
          <p className="text-3xl font-bold text-[#5B89A6]">{props.bookedSlots}</p>
        </div>
        <div className="text-center">
          <p className="text-md font-medium text-[#2E5D78]">Total</p>
          <p className="text-4xl font-extrabold text-[#2E5D78]">{props.totalSlots}</p>
        </div>
      </div>
    </div>
  );
